...
@lazySingleton
class GetQuizletsUseCase extends UseCase<List<QuizletEntity>, NoParams> {
  final QuizletRepository repository;

  GetQuizletsUseCase(this.repository);

  @override
  Future<Either<Failure, List<QuizletEntity>>> call(NoParams params) =>
      repository.getQuizlets();
}
